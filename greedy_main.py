...
T = 300
P = 0.2
t_batchfmnist = 0.0011
tries = 10
m = 5
for t in range(tries):
	dirname = 'diversity_exp/priority4/mnist62/exp'+str(t)
	os.mkdir(dirname)
	...
	# BUILD MODEL
	Ttrain = train_time(args,user_groups,t_batchfmnist)
	malicious_ids = np.random.choice(range(args.num_users), args.malicious, replace=False)
	train_dataset = flip_labels(user_groups,train_dataset1, malicious_ids,6,2)
